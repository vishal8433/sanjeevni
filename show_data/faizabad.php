        ...
        <div class="row">
            <div class="col-sm-4">
              <div class="row">
               <div class="col1">
                <?php
                $users="SELECT * FROM `hospital` WHERE `district`='Faizabad'";
                $run_user=mysqli_query($con,$users);
                echo"</br><h3>Hospitals in<br> Faizabad</h3><hr>";
            ...
            <div class="col-sm-4">
              <div class="row">
               <div class="col1">
                <?php
                $users="SELECT * FROM `blood_bank` WHERE `district`='Faizabad'";
                $run_user=mysqli_query($con,$users);
                echo"</br><h3>Blood Bank in<br> Faizabad</h3><hr>";
                while($row_user=mysqli_fetch_array($run_user)){
                    $user_id=$row_user['id'];
            ...
            <div class="col-sm-4">
              <div class="row">
               <div class="col1">
                <?php
                $users="SELECT * FROM `blood_donor` WHERE `district`='Faizabad'";
                $run_user=mysqli_query($con,$users);
                echo"</br><h3>Blood Donor in<br> Faizabad</h3><hr>";
                while($row_user=mysqli_fetch_array($run_user)){
                    $user_id=$row_user['id'];
                    $h_name=$row_user['name'];
