<!DOCTYPE html>
<?php include("blood_bank_login_script.php")?>
<html>
<head>
    <title>Sanjeevni.com/blood_bank_log_in_page</title>
    <!--required meta tag-->
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="../style/blood_bank_login_stylesheet.css">
    <!--font awesome cdn-->
...
<body>
    ...
    <div class="container-fluid contactform">
        <div class="contact-title">
            <h1 class="loginline"><b>Blood Bank Log In</b></h1>
