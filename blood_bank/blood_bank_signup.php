                    ...
                    <div class="container-fluid contactform">
                        ...
                        <div class="contact-form">
                            <form action="" method="post">
                                ...
                                <input name="b_b_name" type="text" class="form-control" placeholder="Blood Bank Name" autocomplete="off" required><br>
                                <input name="address" type="text" class="form-control" placeholder="Blood Bank Address" autocomplete="off" required><br>
                                ...
                                <input name="b_b_phone_no" type="text" class="form-control" placeholder="Blood Bank Phone Number" autocomplete="off" required><br>
