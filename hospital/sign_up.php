...
<html>
<head>
    <title>Sanjeevni.com/sign_up_page</title>
    <!--required meta tag-->
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="../style/singn_up_stylesheet.css">
                ...
                <div class="row maincontainer">
                    <div class="container-fluid contactform">
                        <div class="contact-title">
                            <h1 class="signupline"><b>Sign up</b></h1>
                        ...
                        <div class="contact-form">
                            <form action="" method="post">
                                ...
                                <select name="ambulance" class="form-control">
                                    <option>Ambulance Availability</option>
                                    <option>Yes</option>
                                    <option>No</option>
                                </select><br>
                                ...
                                <select name="female_doctor_availability" class="form-control">
                                    <option>Female Doctor Availability</option>
                                    <option>Yes</option>
                                    <option>No</option>
                                </select><br>
